...
function App() {
  ...
  const [responseMessage, setResponseMessage] = useState(''); // ✅ added this
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const translatedMessage = response.headers['x-message'] || 'Report generated successfully!'; // fallback
      setResponseMessage(translatedMessage);
    ...
    <div className="min-h-screen p-0 m-0 bg-gray-50">
      ...
      <div className="container mx-auto p-6">
        ...
        <div className="flex flex-col lg:flex-row gap-6 justify-center items-start">
          ...
          {responseMessage && (
            <p className="text-green-600 mt-4 font-semibold">{responseMessage}</p>
          )}
