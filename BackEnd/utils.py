...
try:
    ...
    kidney_model = load_model('models/kidney_ct_model.h5')
    brain_model = load_model('models/brain_model.h5')
    knee_model = load_model('models/knee_classification_model.h5')
    gallbladder_model = load_model('models\gallbladder_model (1).h5')
